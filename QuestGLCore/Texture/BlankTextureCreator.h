...
//		StandardBlankFramebufferTextureCreator(const int width, const int height)
//			:BlankTextureCreator<TextureType>(width, height) {
//		}
...
//		HD16FBlankFramebufferTextureCreator(const int width, const int height)
//			:BlankTextureCreator<TextureType>(width, height) {
//		}
//		void set_parameters() const override {
//			glTexParameteri(TextureType, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
...
//		HD32FBlankFramebufferTextureCreator(const int width, const int height)
//			:BlankTextureCreator<TextureType>(width, height) {
//		}
//		void set_parameters() const override {
//			glTexParameteri(TextureType, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
